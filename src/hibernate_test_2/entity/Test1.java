...
import hibernate_connect.entity.Employee;
...
public class Test1 {
    public static void main(String[] args) {
        SessionFactory factory = new Configuration()        //создаем сесию
                ...
                .addAnnotatedClass(hibernate_connect.entity.Employee.class)          //класс, в котором есть аннотации для работы с базой
                .buildSessionFactory();                     //строит саму сессию

        try {
            Session session = factory.getCurrentSession();
            hibernate_connect.entity.Employee emp = new Employee("Maksim", "Proshin", "Refery", 500000);
